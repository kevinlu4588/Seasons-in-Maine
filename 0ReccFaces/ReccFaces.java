...
public class ReccFaces extends PApplet {
  ...
  //class
    class pathfinder {
      ...
      pathfinder(ReccFaces ReccFaces) {
    	this.ReccFaces = ReccFaces;
        location = new PVector(ReccFaces.random((float)(width*.33), (float)(width*.66)), random(height-100, height - 50));
